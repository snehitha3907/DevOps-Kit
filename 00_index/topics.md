...
- **manifests** (8): [multi-server deployment manifest](../Ansible/manifests/multi-server-deployment.yaml)
...
- _…and 13 more under `Ansible/templates/` — browse the folder._
...
- **scripts** (4): [scan-ansible-antipatterns.py](../Ansible/scripts/scan-ansible-antipatterns.py), [install-and-first-adhoc.sh](../Ansible/scripts/install-and-first-adhoc.sh), [run-first-playbook.sh](../Ansible/scripts/run-first-playbook.sh)
...
- **scripts** (5): [multi-stage Go Docker build](../Docker/scripts/multi-stage-go-dockerfile.sh), [health check + cleanup](../Docker/scripts/docker-health-check-and-cleanup.sh), [install and run first container](../Docker/scripts/install-and-run-first-container.sh)
...
- **scripts** (6): [provision repo with API](../GitHub/scripts/provision-repo-with-api.py), [create repo and PR](../GitHub/scripts/2026-06-12-create-repo-and-pr.sh)
...
- **notes** (3): most recent → [following the quickstart](../GitHub Actions/notes/2026-06-23-following-github-actions-quickstart.md), [0000 primer](../GitHub Actions/notes/0000-primer-github-actions.md)
...
- **notes** (7): most recent → [kubernetes tutorial: what tripped me up](../Kubernetes/notes/2026-08-12-kubernetes-tutorial-what-tripped-me-up.md), [kubectl/minikube first pod](../Kubernetes/notes/2026-09-04-kubectl-minikube-first-pod.md), [first kubectl version and pod from manifest](../Kubernetes/notes/2026-07-19-first-kubectl-version-and-pod-from-manifest.md)
...
Operational notes kept by the kit. Browse the `docs/` folder.
