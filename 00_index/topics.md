...
- **configs** (7): [docker-python-setup.yaml](../Ansible/configs/docker-python-setup.yaml), [nginx-webserver.yaml](../Ansible/configs/nginx-webserver.yaml), [docker-lifecycle-playbook.yml](../Ansible/configs/docker-lifecycle-playbook.yml), [ansible-collection-requirements-and-docker-lifecycle-playbook.yaml](../Ansible/configs/ansible-collection-requirements-and-docker-lifecycle-playbook.yaml)
...
- **scripts** (4): [install-and-first-adhoc.sh](../Ansible/scripts/install-and-first-adhoc.sh), [run-first-playbook.sh](../Ansible/scripts/run-first-playbook.sh), [scan-ansible-antipatterns.py](../Ansible/scripts/scan-ansible-antipatterns.py)
- _…and 1 more under `Ansible/scripts/` — browse the folder._
