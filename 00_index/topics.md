...
- [dockerfile] [Docker/dockerfiles/first-docker-image.Dockerfile](../Docker/dockerfiles/first-docker-image.Dockerfile) — First Dockerfile.
- [dockerfile] [Docker/dockerfiles/tried-building-first-image.Dockerfile](../Docker/dockerfiles/tried-building-first-image.Dockerfile) — Attempt at building a first Docker image.
- [config] [Docker/configs/multi-service-app.yaml](../Docker/configs/multi-service-app.yaml) — Multi-service app compose config.
- [doc] [Docker/docs/docker-run-vs-compose.md](../Docker/docs/docker-run-vs-compose.md) — Decision guide for docker run vs compose.
...
- [script] [Git/scripts/2026-06-10-merge-conflict-practice.sh](../Git/scripts/2026-06-10-merge-conflict-practice.sh) — Scripted scenario to practice resolving merge conflicts.
...
- [note] [GitHub/notes/2026-06-10-github-platform-features.md](../GitHub/notes/2026-06-10-github-platform-features.md) — Walkthrough of wiki, projects, insights, and more.
- [note] [GitHub/notes/2026-06-10-exploring-github-repos-issues-prs.md](../GitHub/notes/2026-06-10-exploring-github-repos-issues-prs.md) — Notes on managing GitHub repos, issues, and pull requests.
...
- [script] [GitHub/scripts/tried-auth-and-profile.sh](../GitHub/scripts/tried-auth-and-profile.sh) — Attempt at GitHub authentication and profile setup.
...
- [script] [Kubernetes/scripts/pod-lifecycle.sh](../Kubernetes/scripts/pod-lifecycle.sh) — Script demonstrating pod lifecycle operations.
- [manifest] [Kubernetes/manifests/stateless-app.yaml](../Kubernetes/manifests/stateless-app.yaml) — Stateless application manifest.
...
- [config] [Terraform/configs/local-file.tf](../Terraform/configs/local-file.tf) — Local file resource configuration example.
