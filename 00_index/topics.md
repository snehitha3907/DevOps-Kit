...
- _…and 3 more under `Ansible/configs/` — browse the folder._
...
- **docs** (2): [wiring-ansible-lint.md](../Ansible/docs/2026-06-15-wiring-ansible-lint.md), [ansible-over-terraform-local-exec.md](../Ansible/docs/ansible-over-terraform-local-exec.md)
...
- **templates** (6): [pre-commit](../Git/templates/git-hooks/pre-commit), [commit-msg](../Git/templates/git-hooks/commit-msg), [post-checkout](../Git/templates/git-hooks/post-checkout)
...
- **configs** (3): [2026-07-13-hello-workflow.yaml](../GitHub Actions/configs/2026-07-13-hello-workflow.yaml), [2026-07-11-first-ci-workflow-hello.yaml](../GitHub Actions/configs/2026-07-11-first-ci-workflow-hello.yaml), [2026-06-23-first-ci-workflow-with-env-and-secrets.yaml](../GitHub Actions/configs/2026-06-23-first-ci-workflow-with-env-and-secrets.yaml)
...
- **configs** (1): [first-pipeline.yaml](../GitLab CI/configs/2026-06-22-first-pipeline.yaml)

## Helm  ·  6 files

- **primer:** [0000-primer-helm.md](../Helm/notes/0000-primer-helm.md)
- **docs** (3): [2026-07-25-add-helm-to-readme-layout-and-coverage.md](../Helm/docs/2026-07-25-add-helm-to-readme-layout-and-coverage.md), [2026-07-22-helm-added-to-readme.md](../Helm/docs/2026-07-22-helm-added-to-readme.md)
- _…and 1 more under `Helm/docs/` — browse the folder._
...
- **manifests** (3): [stateless-app.yaml](../Kubernetes/manifests/stateless-app.yaml), [configmap-secret-mounted-pod.yaml](../Kubernetes/manifests/2026-06-15-configmap-secret-mounted-pod.yaml), [deployment-service-with-probes-limits.yaml](../Kubernetes/manifests/deployment-service-with-probes-limits.yaml)
...
- **notebooks** (1): [comparing-for-each-vs-count.ipynb](../Terraform/notebooks/2026-07-02-comparing-for-each-vs-count.ipynb)
