...
- **Helm** — Kubernetes package manager. Depends on K8s L2 + Docker L2. [Primer](../Helm/notes/0000-primer-helm.md), [install script](../Helm/scripts/2026-07-23-install-helm-and-explore-cli.sh), [chart inspection config](../Helm/configs/2026-07-23-first-helm-chart-inspection.yaml), [live-values config](../Helm/configs/2026-08-29-live-values.yaml), [custom-values install snippet](../Helm/snippets/2026-08-11-nginx-helm-chart-custom-values.sh), [quickstart tripups](../Helm/notes/2026-08-07-helm-quickstart-tripups.md)
