...
- **CI/CD pipeline patterns** — Artifact promotion, rollback triggers, and deployment gates. [Simulated pipeline](../docs/concepts/ci-cd-concepts/scripts/2026-08-04-simulated-cicd-pipeline.sh) · [common patterns](../docs/concepts/ci-cd-concepts/snippets/2026-08-04-cicd-common-patterns.sh)
