...
- **GitHub API approaches** — Comparing REST, GraphQL, and CLI for release automation tasks. [Notebook](../GitHub/notebooks/comparing-api-approaches-release-automation.ipynb)
