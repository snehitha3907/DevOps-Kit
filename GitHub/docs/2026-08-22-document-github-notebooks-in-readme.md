...
1. **README Layout** — Added `notebooks (comparing API approaches for release automation)` to the GitHub/ entry so the folder shows up alongside the existing docs and snippets.
