...
- Added worktree workflows doc: central-checkout layout with one worktree per branch, lock/prune/repair maintenance runbook, hook-isolation gotchas, and rollback for remove/move/prune (git-018) (`Git/docs/worktree-workflows-parallel-branches.md`)
...
- Added Azure provisioning comparison doc: when to reach for Azure CLI vs Bicep vs Python SDK for a small app stack, with credential setup, resource group, networking, compute, and verification steps for each approach (az-014) (`Azure/docs/comparing-azure-cli-bicep-python-sdk.md`)
...
- Added Terraform install and first plan/apply walkthrough using the local_file resource (tf-026) (`Terraform/notes/2026-09-03-install-terraform-and-first-local-file.md`)
